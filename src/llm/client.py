...
def get_agent_llm() -> Any:
    """Return the raw ChatOllama client for tool-calling agent loops.

    Unlike call_ollama(), this returns an invokable chat model rather than
    a validated ReviewOutput — use this wherever bind_tools()/tool-calling
    message loops are needed (e.g. LangGraph agent nodes).
    """
